...
BEGIN
  ...
  v_checksum := md5(
    ...
    COALESCE(array_to_string(v_plant.tags, ','), '') || '|' ||
    COALESCE(v_plant.origin_country, '')
  );
  ...
  INSERT INTO plant_search_index (
    ...
    exposure, climate_zones, hardiness_zones, plant_use, tags, origin_country,
    category_id, price, sale_price, display_order, indexed_at, checksum
  ) VALUES (
    ...
    COALESCE(v_plant.tags, '{}'), v_plant.origin_country,
    v_plant.category_id,
